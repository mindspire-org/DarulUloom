...
router.post('/import-excel', protect, authorize('admin', 'counter1', 'counter2'), async (req, res) => {
    try {
        const results = [];
...
router.put('/counter2/:id', protect, authorize('counter2'), async (req, res) => {
    try {
        ...
        if (req.body.formData) {
            ...
            if (fd.passportNumber !== undefined) student.passportNumber = fd.passportNumber;
            ...
            if (fd.schoolName !== undefined) student.previousMadrasa = fd.schoolName;
